...
export brewList=(
  ...
  "boost::Boost provides free peer-reviewed portable C++ source libraries https://www.boost.org/"
  ...
  "vercel-cli::Vercel combines the best developer experience with an obsessive focus on end-user performance"
